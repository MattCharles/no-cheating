...
namespace Assets.Scripts.PriorityQueue
{
    /// <summary>
    ...
    public class PriorityQueue<TItem, TPriority>
        ...
        public class PriorityQueue<TItem> : PriorityQueue<TItem, float>
        {
            ...
            public PriorityQueue(IComparer<float> comparer) : base(comparer) { }

            /// <summary>
            /// Instantiate a new Priority Queue
            /// </summary>
            /// <param name="comparer">The comparison function to use to compare priority values</param>
            public PriorityQueue(Comparison<float> comparer) : base(comparer) { }
        }
}
